				...
				<div class="banner-wrapper container article_heading">
					<div class="breadcrumbs-wrapper">
						<ul class="phys-breadcrumb">
							<li><a href="himachal.php" class="home">Honeymoon Special</a></li>
					...
					<div class="container">
						<div class="tb_single_tour product">
							<div class="top_content_single row">
								<div class="images images_single_left">
									<div class="title-single">
										<div class="title">
											<h1>Honeymooners Special Volvo Packages
											</h1>
										</div>
										<!-- <div class="tour_code">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/himachal/Himachal1.jpg" class="swipebox" title=""><img width="950" height="700" src="images/himachal/Himachal1.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/himachal/Himachal1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1:( Volvo )</strong></h2>

												<ul>
													<li>Departure from delhi at 05 PM . Travel by over night Volvo A/c Bus from Delhi to Manali.</li>
												</ul>
											</div>
										</div>
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 2: ( Manali )</strong></h2>
												<p>Arrival at Manali in the morning. You will be Picked up from Manali bus stand & than Check in at hotel at 12 Noon. In the Afternoon you can go for half day local city tour. Evening will be at leisure. Dinner & Over night at hotel.</p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 3: ( Manali )</strong></h2>
												<ul>
													<li>Breakfast at hotel. Today full day excursion visit to Rohtang Pass ( Snow Point in case Rohtang is closed due to snow fall) and Solang Valley. Dinner & Over night at hotel.</li>
												</div>
											</div>
											<div class="interary-item">
												<p><span class="icon-left">4</span></p>
												<div class="item_content">
													<h2><strong>Day 4 : ( Manali )</strong></h2>
													<p>After Breakfast at hotel today will be Excursion to Naggar Castle & Art Gallery. Return to hotel in the evening. You can explore the town / go to Mall Road late in the evening on your own. Dinner & Over night at hotel.</p>
												</div>
											</div>
											<div class="interary-item">
												<p><span class="icon-left">5</span></p>
												<div class="item_content">
													<h2><strong>Day 5: ( Manali )</strong></h2>
													<p>Breakfast at hotel . Today could be at leisure or you can pay supplement charges of Rs 2500/- to Rs 3500/- App. and go by Taxi for sightseeing of Kullu & Manikaran Hot Water Springs. Return to hotel in the evening. Dinner & Over night at hotel.</p>
												</div>
											</div>
											<div class="interary-item">
												<p><span class="icon-left">5</span></p>
											...
											<div id="reviews" class="travel_tour-Reviews">
												<div id="comments">
													<h2 class="travel_tour-Reviews-title">1 review for
														<span>Honeymooners Special Volvo Packages</span></h2>
