					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Manipur/valley.jpg" class="swipebox" title=""><img width="430" height="305" src="images/Manipur/valley.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Manipur/valley.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>The Dzuko valley is a famous spot for adventure lovers and trekkers.</p>
										<p>. Well known for its jaw-dropping landscapes and flora, the valley is also among the best treks in Manipur and attracts a constantly growing number of tourists.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-location_tab">
										<p>Distance from Imphal 82.8 km.</p>
