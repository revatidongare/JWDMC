					...
					<div class="container">
						<div class="tb_single_tour product">
							<div class="top_content_single row">
								<div class="images images_single_left">
									<div class="title-single">
										<div class="title">
											<h1>BALI-CHEDI CLUB TANAH GAJAH RESORT
											</h1>
										</div>
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Bali/bali2.jpg" class="swipebox" title=""><img width="950" height="700" src="images/Bali/bali2.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Bali/bali2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
											...
											<div id="reviews" class="travel_tour-Reviews">
												<div id="comments">
													<h2 class="travel_tour-Reviews-title">1 review for
														<span>BALI-CHEDI CLUB TANAH GAJAH RESORT</span></h2>
