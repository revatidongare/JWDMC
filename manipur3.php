					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Manipur/orchid.jpg" class="swipebox" title=""><img width="430" height="305" src="images/Manipur/orchid.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Manipur/orchid.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>A paradise of orchids with more than 110 unique varieties across 200 acres, the Orchidarium is not to be missed in the blooming season of March-April. </p>
										<p>Vibrant flowers with sweet fragrance and wonderful views, the Khonghampat Orchidarium is a whole new world!</p>
										...
										<ph>The Khonghampat Orchidarium is a whole new world!</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-location_tab">
										<p>Distance from Imphal 10 km.</p>
										...
										<div id="reviews" class="travel_tour-Reviews">
											<div id="comments">
												<h2 class="travel_tour-Reviews-title">1 review for
													<span>Khonghampat Orchidarium</span></h2>
