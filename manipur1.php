	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(images/banner/top-heading.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<h2 class="heading_primary">North East</h2></div>
		</div>
					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Manipur/history.jpeg" class="swipebox" title=""><img width="430" height="305" src="images/Manipur/history.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Manipur/history.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>Ruled by kings for over centuries, the ancient history of Manipur dates back to 33 A.D. </p>
										<p>The birthplace of Modern Polo, a land of exquisite culture and diverse ethnicity, the rich and vibrant past of Manipur still remains unexplored.</p>
												...
												<td>
													<table>
														...
														<tr>
															...
															<td><i class="fa fa-check icon-tick icon-tick--on"></i>Professional guide
															</td>
														</tr>
														</tbody>
													</table>
										...
										<p>. A historian’s utopia, a land of ancient relics, war memorials, monuments, and temples- Manipur is truly a blast from the past.</p>
										...
										<div id="reviews" class="travel_tour-Reviews">
											<div id="comments">
												<h2 class="travel_tour-Reviews-title">1 review for
													<span>History of Manipur</span></h2>
