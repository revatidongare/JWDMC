					...
					<div class="container">
						<div class="tb_single_tour product">
							<div class="top_content_single row">
								<div class="images images_single_left">
									<div class="title-single">
										<div class="title">
											<h1>Romantic Coorg with Mysore-1
											</h1>
										</div>
										<!-- <div class="tour_code">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/feel/430x305/feel3.jpg" class="swipebox" title=""><img width="950" height="700" src="images/feel/430x305/feel3.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/feel/430x305/feel3.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1: Bengaluru – Coorg</strong></h2>

												<ul>
													<p>On arrival at Bengaluru Airport, transfer to Coorg.On arrival check in at the hotel. Later proceed to visit Madicari Palace, Medikeri fort, The Tibetan Monastery(Tibeten Golden Temple) Rest of day free for leisure and overnight stay at Hotel.
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 2:Coorg Sightseeing

												</strong></h2><ul>
													<p>After breakfast proceed for full day excursion to Madikeri, known as Scotland of India. visit Dubare Elephant Camps. Raja Seat, Omkareshwar Temple, en route visiting Abbey Falls . Clock Tower, Cauvery Nisargadhama ,Nalaknad Palace, Spend the evening at leisure & stay overnight at hotel.
											...
											<div class="interary-item">
												...
												<div class="item_content">
													<h2><strong>Day 4 :Coorg- Mysore
													</strong></h2><ul>
														<p>In the morning, check out from hotel. Transfer by road to Mysore. On arrival check into hotel. Later proceed for local sightseeing which includes visit to Mysore Palace, Srirangapatna, Brindavan Gardens etc .Overnight stay in Mysore Hotel.
												...
												<div class="interary-item">
													...
													<div class="item_content">
														...
														<ul>
															<p>After having breakfast into the hotel, check out from hotel and transfers by road to Bangalore airport. Tour end.
													...
													<div id="reviews" class="travel_tour-Reviews">
														<div id="comments">
															<h2 class="travel_tour-Reviews-title">1 review for
																<span>Romantic Coorg with Mysore-1</span></h2>
