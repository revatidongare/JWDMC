					...
					<div class="container">
						<div class="tb_single_tour product">
							<div class="top_content_single row">
								<div class="images images_single_left">
									<div class="title-single">
										<div class="title">
											<h1>HERITAGE AWALI  RESORT -ROMANTIC MAURITIUS 
											</h1>
										</div>
										<!-- <div class="tour_code">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Mauritius/mauritius.jpg" class="swipebox" title=""><img width="950" height="700" src="images/Mauritius/mauritius.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Mauritius/mauritius.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
											...
											<div id="reviews" class="travel_tour-Reviews">
												<div id="comments">
													<h2 class="travel_tour-Reviews-title">1 review for
														<span>HERITAGE AWALI  RESORT -ROMANTIC MAURITIUS</span></h2>
