					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Manipur/cave.jpg" class="swipebox" title=""><img width="430" height="305" src="images/Manipur/cave.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Manipur/cave.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>Enclosed by different patterns of stalagmites and stalactites, caving in here through the depth and in darkness is an enthralling experience for tourists, archaeologists, and researchers from all around the globe.</p>
										...
										<p>An enchanting beauty not to be missed.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-location_tab">
										<p>Distance from Imphal 90 km</p>
										...
										<div id="reviews" class="travel_tour-Reviews">
											<div id="comments">
												<h2 class="travel_tour-Reviews-title">1 review for
													<span>Khangkhui Lime Caves</span></h2>
