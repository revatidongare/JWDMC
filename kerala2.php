					...
					<div class="container">
						<div class="tb_single_tour product">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/kerala/kerala2.jpg" class="swipebox" title=""><img width="950" height="700" src="images/kerala/kerala2.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/kerala/kerala2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1:Kochi – Munnar
</strong></h2>

												<ul>
													<p>In the Afternoon ,Arrive at Kochi Airport and then transfers to Munnar (Appr.3 hrs ) .Later check into hotel. Rest of the day at own leisure. Overnight stay in Munnar.
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 2:Munnar ​

												</strong></h2><ul>
													<p>In morning, proceed to local sightseeing which includes Eco Point, Mattupetty Dam, Blossom Garden Parl Tata Tea Plantation, Kundala Lake, etc. Rest of the day at own leisure. Overnight stay in Munnar.
											...
											<div class="interary-item">
												...
												<div class="item_content">
													<h2><strong>Day 3:Munnar

													</strong></h2>
													<ul>
														<p>In the morning, proceed to visit Rajamalai and Eravikulam Wildlife Sanctuary famous for the Nilgiri Tahr and tea gardens,Devikulam, Attukal Dreamland Spice park Waterfalls etc. Overnight stay in Munnar.
											...
											<div class="interary-item">
												...
												<div class="item_content">
													<h2><strong>Day 4 :Munnar – Thekkady

													</strong></h2><ul>
														<p>In the morning, check out from hotel and transfer to Thekkady to enjoy the beauty of Periyar lake and kerala wildlife . On arrival in Thekkady proceed for Periyar lake to enjoy boating on lake . Periyar National park, enjoy elephant riding (pay extra). Later back to hotel for relax. Overnight stay in Thekkady.
												...
												<div class="interary-item">
													...
													<div class="item_content">
														<h2><strong>Day 5:Munnar – Thekkady

														</strong></h2>
														<ul>
															<p>After having breakfast, in the hotel checks out from hotel drive to Alleppey. On Arrival, check into Backwater Resort. Relax in Resort. Enjoy the beautiful view and nature of Kerala and get to know why it calls ‘Gods Own Country”. Overnight stay in Resort.
													...
													<div class="interary-item">
														...
														<div class="item_content">
															<h2><strong>Day 6:Departure
														</strong></h2>
															<ul>
																<p>After having breakfast, check out from houseboat and drive back to Kochi Airport/ Rail station for homeward journey. Tour End.
															...
															<div id="reviews" class="travel_tour-Reviews">
																<div id="comments">
																	<h2 class="travel_tour-Reviews-title">1 review for
																		<span>Romantic Kerala Memories</span></h2>
