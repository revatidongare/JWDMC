					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Manipur/shirui.jpg" class="swipebox" title=""><img width="430" height="305" src="images/Manipur/shirui.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Manipur/shirui.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>The Shirui hills are home to some rare birds and wildlife</p>
										<p>The Shurui lilies bloom in plethora during the month of May and June, adorning the hilltop of the peak. This magnificent beauty promises to make your trek purely magical.</p>
