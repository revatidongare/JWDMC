					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/tour/simply.jpg" class="swipebox" title=""><img width="950" height="700" src="images/tour/simply.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
										<a href="images/tour/
Highlight
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<table class="tours-tabs_table">
											...
											<tr>
												...
												<td>Brisbane Airport for your flight back home</td>
											</tr>
											<tr>
										...
										<p>Australia's capital is Canberra, located in the southeast between the larger and more important economic and cultural centres of Sydney and Melbourne.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										<div class="interary-item">
											...
											<div class="item_content">
												...
												<ul>
												<li>Arrive into Sydney. Transfer you to your hotel. Rest of the day is at leisure.</li>
												</ul>
											</div>
										</div>
										<div class="interary-item">
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 4 : Sydney – Brisbane – Cairns</strong></h2>
												<p>Transfer to Sydney Airport for flight to Cairns. Arrive Cairns and transfer you to your hotel. Rest of the day is free at leisure.</p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">5</span></p>
											<div class="item_content">
												<h2><strong>Day 5 : Cairns</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 6 : Cairns</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 7 : Cairns – Brisbane - Gold Coast </strong></h2>
												<p>Transfer to Cairns Airport for flight to Brisbane. Arrive Brisbane and transfer to your hotel in Gold Coast. Rest of the day is at leisure</p> 
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">8</span></p>
											<div class="item_content">
												<h2><strong>Day 8 : Gold Coast </strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 9 : Gold Coast </strong></h2>
												<p>The day is free at leisure to explore Gold Coast on your own.  </p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">10</span></p>
											<div class="item_content">
												<h2><strong>Day 10 : Gold Coast – Depart Brisbane</strong></h2>
												<p>Transfer to Brisbane Airport for your flight back home</p>
											</div>
										</div>
									</div>
