				...
				<div class="banner-wrapper container article_heading">
					<div class="breadcrumbs-wrapper">
						<ul class="phys-breadcrumb">
							<li><a href="kerala.php" class="home">Honeymoon Special</a></li>
					...
					<div class="container">
						<div class="tb_single_tour product">
							<div class="top_content_single row">
								<div class="images images_single_left">
									<div class="title-single">
										<div class="title">
											<h1>Romantic Kerala -The Panaromic Gateway Resort
											</h1>
										</div>
										<!-- <div class="tour_code">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="images/Kerala/Kerala1.jpg" class="swipebox" title=""><img width="950" height="700" src="images/Kerala/Kerala1.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="images/Kerala/Kerala1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1:Kochi – Munnar</strong></h2>

												<ul>
													<li>In the Afternoon ,Arrive at Kochi Airport and then transfers to Munnar (Appr.3 hrs ) .Later check into hotel. Rest of the day at own leisure. Overnight stay in Munnar.</li>
												</ul>
											</div>
										</div>
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 2:Munnar</strong></h2>
												<p>In morning, proceed to local sightseeing which includes Eco Point, Mattupetty Dam, Blossom Garden Parl Tata Tea Plantation, Kundala Lake, etc. Rest of the day at own leisure. Overnight stay in Munnar.</p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 3:Munnar</strong></h2>
												<ul>
													<li>In the morning, proceed to visit Rajamalai and Eravikulam Wildlife Sanctuary famous for the Nilgiri Tahr and tea gardens,Devikulam,Attukal Dreamland Spice park Waterfalls etc. Overnight stay in Munnar.
											...
											<div class="interary-item">
												...
												<div class="item_content">
													<h2><strong>Day 4 :Munnar –Alleppey
													</strong></h2>
													<p>After having breakfast,in the hotel check out from hotel drive to Alleppey. On Arrival,check into Houseboat.After lunch, your houseboat driver will take you to show beautiful backwaters of Alleppey, Kumarkom. Enjoy the beautiful view and nature of Kerala and get to know why it calls ‘Gods Own Country”. Overnight stay in Houseboat.</p>
												</div>
											</div>
											<div class="interary-item">
												...
												<div class="item_content">
													...
													<p>After having breakfast, check out from houseboat and drive back to Kochi Airport/ Rail station for homeward journey. Tour End.</p>
												</div>
											</div>
											<!-- <div class="interary-item">
												<p><span class="icon-left">5</span></p>
												<div class="item_content">
													<h2><strong>Day 5: ( Volvo)</strong></h2>
													<p>After Breakfast at hotel you need to vacate the room by 11 AM. Afternoon will be at leisure .You can explore the Shopping malls of Manali on your own. In the evening at 04 PM board the Volvo AC bus for Delhi for over night journey. Drop from Hotel to Manali Bus Stand by Taxi will be provided by us .</p>
												</div>
											</div>
											<div class="interary-item">
												<p><span class="icon-left">5</span></p>
											...
											<div id="reviews" class="travel_tour-Reviews">
												<div id="comments">
													<h2 class="travel_tour-Reviews-title">1 review for
														<span>Romantic Kerala -The Panaromic Gateway Resort</span></h2>
