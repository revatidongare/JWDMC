...
<div class="wrapper-container">
			...
			<div class="container">
				...
				<nav class="width-navigation">
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						...
						<li class="current-menu-ancestor"><a href="destinations.html">Destinations</a></li>
	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="color: rgb(255, 255, 255); background-color: rgb(0, 0, 0); background-image: url('http://travelwp.physcode.com/wp-content/uploads/2017/03/brazil.jpg')">
