				...
				<div class="banner-wrapper container article_heading">
					<div class="breadcrumbs-wrapper">
						<ul class="phys-breadcrumb">
							<li><a href="mauritius.php" class="home">Honeymoon Special</a></li>
							...
							<div class="top_content_single row">
								<div class="images images_single_left">
									<div class="title-single">
										<div class="title">
											<h1>The Ravenala Attitude  -Romantic Mauritius
											</h1>
										</div>
									...
									<div id="slider" class="flexslider">
										<ul class="slides">
											<li>
												<a href="images/Mauritius/mauritius1.jpg" class="swipebox" title=""><img width="950" height="700" src="images/Mauritius/mauritius1.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
											</li>
											<li>
									...
									<div id="carousel" class="flexslider thumbnail_product">
										<ul class="slides">
											<li>
												<img width="150" height="100" src="images/Mauritius/mauritius1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
											</li>
											<li>
											...
											<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
												<div class="interary-item">
													...
													<div class="item_content">
														<h2><strong>Day 1:Arrive Mauritius – Day at leisure
												...
												<div class="interary-item">
													...
													<div class="item_content">
														<h2><strong>Day 6:Day at Leisure
														</strong></h2>
														<ul>
															<p>After breakfast, while your day is free at leisure. Stay overnight at hotel / resort in Mauritius.
												...
												<div class="interary-item">
													...
													<div class="item_content">
														<h2><strong>Day 7:Depart Mauritius

														</strong></h2>
														<ul>
															<p>After your last breakfast in Mauritius, proceed to the airport for your home bound flight.
												...
												<div id="reviews" class="travel_tour-Reviews">
													<div id="comments">
														<h2 class="travel_tour-Reviews-title">1 review for
															<span>The Ravenala Attitude  -Romantic Mauritius</span></h2>
