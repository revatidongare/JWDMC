	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(images/banner/top-heading.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<h1 class="heading_primary">Romantic Koh Samui Island</h1></div>
		</div>
								...
								<div class="item_border item-product">
									<div class="post_images">
										<a href="single-tour.html">
											<img width="430" height="305" src="images/Island/island1.jpg" alt="ROMANTIC KOH SAMUI  WITH BANGKOK -KC RESORT SPECIAL  " title="ROMANTIC KOH SAMUI  WITH BANGKOK -KC RESORT SPECIAL  ">
										</a>
									...
									<div class="wrapper_content">
										<div class="post_title"><h4>
											<a href="single-tour.html" rel="bookmark">ROMANTIC KOH SAMUI  WITH BANGKOK -KC RESORT SPECIAL  </a>
										</h4></div>
