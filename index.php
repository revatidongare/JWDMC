								...
								<div class="carousel-outer">
									...
									<div class="full-screen-outer" style="display: none;">
										<ul class="fullscreen-carousel owl-theme owl-carousel">
											...
											<li class="slide-item" style="background-image:url(images/tour/430x305/Highlight.jpg);">
												<div class="outer-container">
													<div class="content">
														<h3>Grand Apartment</h3>
														<div class="title">Modern Building</div>
											...
											<li class="slide-item" style="background-image:url(images/tour/430x305/simply.jpg);">
												<div class="outer-container">
													<div class="content">
														<h3>Sweet Home</h3>
														<div class="title">Modern Building</div>
									...
									<div class="thumbs-outer-box">
										<div class="auto-container">
											<ul class="thumbs-carousel owl-theme owl-carousel">
												...
												<li class="slide-item"><figure class="image"><img src="images/tour/430x305/simply.jpg" alt=""></figure></li>
												<li class="slide-item"><figure class="image"><img src="images/tour/430x305/Highlight.jpg" alt=""></figure></li>
												<li class="slide-item"><figure class="image"><img src="images/tour/430x305/tour-2.jpg" alt=""></figure></li>
												<li class="slide-item"><figure class="image"><img src="images/tour/430x305/tour-3.jpg" alt=""></figure></li>
												<li class="slide-item"><figure class="image"><img src="images/tour/430x305/tour-4.jpg" alt=""></figure></li>
												<li class="slide-item"><figure class="image"><img src="images/tour/430x305/tour-5.jpg" alt=""></figure></li>
