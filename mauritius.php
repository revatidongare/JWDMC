	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(images/banner/top-heading.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<h1 class="heading_primary">Romantic Mauritius</h1></div>
		</div>
							...
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									<div class="post_images">
										<a href="mauritius1.php">
											
											<img width="430" height="305" src="images/Mauritius/mauritius.jpg" alt="Discover Brazil" title="Discover Brazil">
										</a>
									
									</div>
									<div class="wrapper_content">
										<div class="post_title"><h4>
											<a href="mauritius1.php" rel="bookmark">HERITAGE AWALI  RESORT -ROMANTIC MAURITIUS </a></h4>
										</div>
									...
									<div class="read_more">
										...
										<a rel="nofollow" href="mauritius1.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
									</div>
								</div>
							</li>
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									<div class="post_images">
										<a href="mauritius2.php">
											
											
											
											<img width="430" height="305" src="images/Mauritius/mauritius1.jpg" alt="Discover Brazil" title="Discover Brazil">
										</a>
										
									</div>
									<div class="wrapper_content">
										<div class="post_title"><h4>
											<a href="mauritius2.php" rel="bookmark">The Ravenala Attitude  -Romantic Mauritius"</a>
										</h4></div>
										<span class="post_date">Coming Soon</span>
									...
									<div class="read_more">
										...
										<a rel="nofollow" href="mauritius2.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
									</div>
								</div>
							</li>
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									<div class="post_images">
										<a href="mauritius3.php">
											
											<img width="430" height="305" src="images/Mauritius/mauritius2.jpg" alt="Discover Brazil" title="Discover Brazil">
										</a>
										
									</div>
									<div class="wrapper_content">
										<div class="post_title"><h4>
											<a href="mauritius3.php" rel="bookmark">TROPICAL ATTITUDE RESORT -ROMANTIC MAURITIUS </a>
										</h4></div>
										<span class="post_date">Coming Soon</span>
										<marquee class="ubuntu-l" style="color:#ff7a59;font-size:18px;font-weight:bold;">Room Decoration on 1st Night, Kesar /Badam Milk every Night In The Coorg Resort, Candle Light Dinner, Chocolates,Cookies, Honeymoon Special Cake</marquee>
									...
									<div class="read_more">
										...
										<a rel="nofollow" href="mauritius3.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
									</div>
								</div>
							</li>
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									<div class="post_images">
										<a href="mauritius4.php">
											
											<img width="430" height="305" src="images/Mauritius/mauritius3.jpg" alt="Discover Brazil" title="Discover Brazil">
										</a>
										
									</div>
									<div class="wrapper_content">
										<div class="post_title"><h4>
											<a href="mauritius4.php" rel="bookmark">Veranda Paul Et Virginie Resort -Romantic Mauritius</a>
										</h4></div>
										<span class="post_date">Coming Soon</span>
										<marquee class="ubuntu-l" style="color:#ff7a59;font-size:18px;font-weight:bold;">Room Decoration on 1st Night, Kesar /Badam Milk every Night In The Coorg Resort, Candle Light Dinner, Chocolates,Cookies, Honeymoon Special Cake</marquee>
									...
									<div class="read_more">
										...
										<a rel="nofollow" href="mauritius4.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
									</div>
								</div>
							</li>
							<!-- <li class="item-tour col-md-4 col-sm-6 product">
