										...
										<div class="wrapper-special-tours">
											...
											<div class="inner-special-tours">
												<a href="Tripura6.php">
													...
													<img width="430" height="305" src="images/Tripura/pilak.jpg" alt="Pilak Archaeological Sites" title="Pilak Archaeological Sites"></a>
												<div class="item_rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
												...
												<div class="post_title"><h3>
													<a href="Tripura6.html" rel="bookmark">Pilak Archaeological Sites</a>
												</h3></div>
												<div class="item_price">
